      ...
      <?php
        ...
        <!-- Disable to go to left page button if $page is equal to 0 or first page-->
                        <a disabled="disabled" class="pagination-previous" href="index.php?page=javascript:void(0)"> &#60;&#60; </a>
                        <?php else:?>
        ...
        <!-- Next page start-->
                        <?php if ($page == $total) :?>
                              <a class="pagination-next" disabled="disabled" href="javascript:void(0)">  	&#62;&#62; </a>
